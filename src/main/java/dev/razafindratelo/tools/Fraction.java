...
public class Fraction {
  ...
  public static Fraction getRandom(long from, long to) {
    ...
    if (BigInteger.ZERO.equals(den)) den = BigInteger.ONE;
  ...
  public Fraction add(Fraction f) {
    BigInteger newNumerator =
        this.numerator.multiply(f.denominator).add(f.numerator.multiply(this.denominator));
  ...
  public Fraction multiply(Fraction f) {
    ...
    return new Fraction(
        this.numerator.multiply(f.numerator), this.denominator.multiply(f.denominator));
  }
