...
class SquareRootTest {
    ...
    void test_square_root_of_1() {
        ...
        String actual = subject.kThValue(1).getValue(precision).toString();

        assertEquals(expected, actual);
    }

    @Test
    void test_the_square_root_of_2_with_20_001_decimals_for_k_eq_20() throws IOException {
        ...
        String actual = subject.kThValue(20).getValue(precision).toString().substring(0, 20_002);
    ...
    void test_the_square_root_of_4() {
        ...
        MathContext precision = new MathContext(2);
        String actual = subject.kThValue(2).getValue(precision).toString();
    ...
    void test_the_square_root_of_7_with_20_000_decimals_for_k_eq_20() throws IOException {
        ...
        MathContext precision = new MathContext(20_002);
        String actual = sqrt7.kThValue(20).getValue(precision).toString().substring(0, 20_002);
        assertEquals(expected, actual);
    }
    ...
    void test_golden_ratio_decimals_with_20_000_decimals_for_k_eq_20() throws IOException {
        ...
        MathContext precision = new MathContext(20_002);
        BigDecimal sqrt5 = SQRT5.kThValue(20).getValue(precision);
